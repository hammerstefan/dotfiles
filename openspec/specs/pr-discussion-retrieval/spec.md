...
Bounded, read-only retrieval of a pull request's prior review conversation
(submitted reviews, review threads with resolution state, issue comments) via
one fixed GraphQL call.
