...
Mode-dependent integration of a prior-review digest into the review council
workflow — flag semantics, coordinator-owned digest, blindness routing across
triage, specialists, chair, and the human-attention agent, untrusted-data
handling, and degrade-on-failure coverage reporting.
